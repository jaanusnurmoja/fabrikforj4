...
class FabSiteModel extends BaseDatabaseModel
{
	 ...
	 */
	protected function _createTable($name, $prefix = '', $config = array())
	{
		...
		return Factory::getApplication()->bootComponent('com_fabrik')->getMVCFactory()->createTable($name, 'Administrator', $config);	
