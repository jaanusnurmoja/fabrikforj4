 ...
 * @since    3.0
 */
class ElementlistModel extends PluginelementModel {
	/**
	...
	public static function cacheAutoCompleteOptions($elementModel, $search, $opts = array()) {
		...
		$label = FabrikArray::getValue($opts, 'label', '');
	...
	public function renderListData($data, \stdClass  &$thisRow, $opts = array()) {
		...
		$layout = FabrikHtml::getLayout('fabrik-element-elementlist-details',
	...
	public function render($data, $repeatCounter = 0) {
		...
		$grid = FabrikHtml::grid($values, $labels, $selected, $name, $this->inputType, $elBeforeLabel, $optionsPerRow, $classes, $buttonGroup, $dataAttributes);
...
//		return FabrikWorker::j3() && $params->get('btnGroup', false);
	...
	public function notreadyyet_getLabelForValue($v, $defaultLabel = '') {
		...
		foreach ($vals as $val) {
			$l = FabrikArray::getValue($labels, $val, $defaultLabel);
