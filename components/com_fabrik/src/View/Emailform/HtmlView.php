 ...
 */
namespace Fabrikar\Component\Fabrik\Site\View\Emailform;
...
//		$model  = $this->getModel('form');// F5: can't use getModel in a view
		$model = Factory::getApplication()->bootComponent('com_fabrik')->getMVCFactory()->createModel('Form', 'Site');
//print_r("model = ");print_r($model);exit;// empty
