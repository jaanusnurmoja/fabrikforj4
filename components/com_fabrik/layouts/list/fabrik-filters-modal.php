...
<div data-modal-state-container style="display:<?php echo $showClearFilters ? '' : 'none'; ?>">
	...
	<span data-modal-state-display>
		<?php $layout = FabrikHtml::getLayout('list.fabrik-filters-modal-state-label');
		foreach ($d->filters as $key => $filter):
			if ($filter->displayValue !== ''):
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content draggable">
			<div class="modal-header ">
				<h5 class="modal-title"><?php echo FabrikHtml::icon('icon-filter', Text::_('COM_FABRIK_FILTER')); ?></h5>
			...
			<div class="modal-body p-3">
				<div class="row">
					...
					$chunkedFilters = FabrikArray::chunk($chunkedFilters, $d->filterCols, true);
			...
			<div class="modal-footer justify-content-between">
				<?php if ($d->filter_action != 'onchange'):	?>
