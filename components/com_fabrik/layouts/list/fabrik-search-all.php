...
<?php
if ($d->advanced) :
	echo '<div class="col-auto ps-1">';
	echo HTMLHelper::_('select.genericList', $d->searchOpts, 'search-mode-advanced', "class='form-select-sm' style='float:right'", 'value', 'text', $d->mode);
	echo '</div>';
endif;
