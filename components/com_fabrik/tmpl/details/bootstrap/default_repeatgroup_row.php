 	...
 	if ($group->editable) : ?>
		<td class="fabrikGroupRepeater pull-right">
			...
			<a class="addGroup" href="#">
				<?php echo FabrikHtml::image('plus', 'form', $this->tmpl, array('class' => 'fabrikTip tip-small', 'title' => Text::_('COM_FABRIK_ADD_GROUP')));?>
			</a>
			<?php
			endif;
			if ($group->canDeleteRepeat) :?>
			<a class="deleteGroup" href="#">
				<?php echo FabrikHtml::image('minus', 'form', $this->tmpl, array('class' => 'fabrikTip tip-small', 'title' => Text::_('COM_FABRIK_DELETE_GROUP')));?>
			</a>
			<?php endif;?>
		</td>
	<?php endif; ?>
