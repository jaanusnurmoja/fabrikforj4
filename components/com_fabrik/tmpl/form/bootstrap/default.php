...
<div class="row-fluid nav">
	<div class="<?php echo FabrikHtml::getGridSpan(6); ?> pull-right">
		<?php
		echo $this->loadTemplate('buttons');
		?>
	</div>
	<div class="<?php echo FabrikHtml::getGridSpan(6); ?>">
		<?php
...
foreach ($this->groups as $group) :
	...
	<fieldset class="<?php echo $group->class; ?>" id="group<?php echo $group->id;?>" style="<?php echo $group->css;?>">
		 ...
		 */
		$this->elements = $group->elements;// ok all elements that should display
		echo $this->loadTemplate($group->tmpl);// ok group
//print_r("group->elements = ");print_r($group->elements);exit;
