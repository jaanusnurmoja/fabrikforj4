					...
					<?php if ($group->editable) { ?>
						<div class="fabrikGroupRepeater">
							...
							<a class="addGroup" href="#">
								<?php echo FabrikHtml::image('plus', 'form', $this->tmpl, Text::_('COM_FABRIK_ADD_GROUP'));?>
							</a>
							<?php }?>
							<a class="deleteGroup" href="#">
								<?php echo FabrikHtml::image('minus', 'form', $this->tmpl, Text::_('COM_FABRIK_DELETE_GROUP'));?>
							</a>
						</div>
					<?php } ?>
				</div>
