...
ALTER TABLE `#__fabrik_cron` MODIFY `modified` datetime NOT NULL;
ALTER TABLE `#__fabrik_cron` ALTER `modified` DROP DEFAULT;
...
ALTER TABLE `#__fabrik_elements` MODIFY `modified` datetime NOT NULL;
ALTER TABLE `#__fabrik_elements` ALTER `modified` DROP DEFAULT;
...
ALTER TABLE `#__fabrik_forms` MODIFY `modified` datetime NOT NULL;
ALTER TABLE `#__fabrik_forms` ALTER `modified` DROP DEFAULT;
...
ALTER TABLE `#__fabrik_groups` MODIFY `modified` datetime NOT NULL;
ALTER TABLE `#__fabrik_groups` ALTER `modified` DROP DEFAULT;
...
ALTER TABLE `#__fabrik_lists` MODIFY `modified` datetime NOT NULL;
ALTER TABLE `#__fabrik_lists` ALTER `modified` DROP DEFAULT;
...
ALTER TABLE `#__fabrik_visualizations` MODIFY `modified` datetime NOT NULL;
ALTER TABLE `#__fabrik_visualizations` ALTER `modified` DROP DEFAULT;
