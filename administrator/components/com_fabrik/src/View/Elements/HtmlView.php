...
namespace Fabrikar\Component\Fabrik\Administrator\View\Elements;
...
//		require_once JPATH_COMPONENT . '/helpers/fabrik.php';
	...
	protected function confirmdelete($tpl = null) {
		$model = $this->getModel();
//		$model = Factory::getApplication()->bootComponent('com_fabrik')->getMVCFactory()->createModel('Elements', 'Administrator');
		$app = Factory::getApplication();
		$input = $app->input;
