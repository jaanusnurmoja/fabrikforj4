 ...
 * @since       3.0
 */
class CronsController extends FabAdminController {
	/**
	 ...
	 * @return  J model
	 */
	public function getModel($name = 'Cron', $prefix = '', $config = array()) {
	...
	public function run() {
		...
		$adminListModel = Factory::getApplication()->bootComponent('com_fabrik')->getMVCFactory()->createModel('List', '');
//		$this->createModel('List', 'Adminstrator');
		$pluginManager = Factory::getApplication()->bootComponent('com_fabrik')->getMVCFactory()->createModel('Pluginmanager', 'Site');
//		$this->createModel('Pluginmanager', 'Site');// but we move Pluginmanager to Adminstrator
		$listModel = Factory::getApplication()->bootComponent('com_fabrik')->getMVCFactory()->createModel('List', 'Site');
//		Remove $listModel and copy the $listModel function to $adminListModel
		$c = 0;
