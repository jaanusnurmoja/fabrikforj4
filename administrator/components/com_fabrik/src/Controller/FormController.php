 ...
 * @since       3.0
 */
class FormController extends FabFormController {
	/**
	...
	public function view() {
		...
		$viewLayout = $input->get('layout', 'edit');
		$this->name = 'Fabrik';
		$view = $this->getView('Form', $viewType, 'Site', ["base_path" => COM_FABRIK_FRONTEND]);
		...
		FabrikHelper::addSubmenu($input->get('view', 'lists', 'word'));
	}
	...
	public function process() {
		...
		if ($model = Factory::getApplication()->bootComponent('com_fabrik')->getMVCFactory()->createModel('Form', 'Site')) {
			$view->setModel($model, true);
		}
...
$model    = Factory::getApplication()->bootComponent('com_fabrik')->getMVCFactory()->createModel('List', '');
