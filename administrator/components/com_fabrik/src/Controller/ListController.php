 ...
 * @since       3.0
 */
class ListController extends FabFormController {
	/**
	...
	public function view($model = null) {
		...
		$view = $this->getView($this->view_item, $viewType, 'Site');
		$view->setModel($model, true);
		...
		if (!FabrikWorker::useCache($model)) {
			$view->display();
		} else {
	...
	public function save($key = null, $urlVar = null) {
		$data = (array) $this->input->post->get('jform', array(), 'array'); // not needed here, already in parent
		/*
