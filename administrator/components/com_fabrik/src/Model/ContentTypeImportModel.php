...
class ContentTypeImportModel extends FabAdminModel
{
	...
	public function __construct($config = array())
	{
		...
		$listModel = ArrayHelper::getValue($config, 'listModel', Factory::getApplication()->bootComponent('com_fabrik')->getMVCFactory()->createModel('List', 'Administrator'));

		if ($listModel instanceof ListModel === false)
		{
