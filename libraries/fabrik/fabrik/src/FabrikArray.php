...
class FabrikArray {
	 ...
	 * @since	1.5
	 */
// already in Joomla\Utilities\ArrayHelper
/*
 ...
 */
	...
	/**
	 * Workaround for J! 3.4 change in FabrikArray::getValue(), which now forces $array to be, well, an array.
	 * We've been a bit naughty and using it for things like SimpleXMLElement.  So for J! 3.4 release, 2/25/2015,
	 * globally replaced all use of FabrikArray::getValue() with FabrikArray::getValue().  This code is just a
	 ...
	 * @since   1.0
	 */
// already in Joomla\Utilities\FabrikArray
/*
