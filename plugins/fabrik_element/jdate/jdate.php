...
//		$local = $formModel->hasErrors() || $params->get('jdate_store_as_local', 0) == 1) && $value != 'now' ? false : true;
	...
	public function formJavascriptClass(&$srcs, $script = '', &$shim = array())
	{
		...
		if (FabrikHelperHTML::inAjaxLoadedPage()) {
			...
			$shim[$key]->deps[] = Juri::root() .'media/system/js/fields/calendar.min.js';
			$shim[Juri::root() .'media/system/js/fields/calendar.min.js'] = $globalShim;
			$shim[$key]->deps[] = Juri::root() .'media/system/js/fields/calendar-locales/date/gregorian/date-helper.min.js';
			$shim[Juri::root() .'media/system/js/fields/calendar-locales/date/gregorian/date-helper.min.js'] = $globalShim;
		}
