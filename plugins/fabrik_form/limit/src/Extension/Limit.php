...
namespace Fabrik\Plugin\Form\Limit\Extension;
 ...
 * @since       3.0
 */
class Limit extends PluginformModel implements SubscriberInterface
{
	...
	protected function count()
	{
		...
		*/
		...
		if (!empty($fk))
		{
			$fkVal = FabrikArray::getValue(
					$formModel->data,
					FabrikString::safeColNameToArrayKey($fk),
					FabrikArray::getValue(
							$formModel->data,
