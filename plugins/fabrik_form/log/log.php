...
class PlgFabrik_FormLog extends PlgFabrik_Form
{
	...
	public function install()
	{
		...
		$sqls = [
			...
			"UPDATE `#__fabrik_change_log_fields` SET `time_date` = '1980-01-01 00:00:00' WHERE `time_date` < '1000-01-01';",
			...
			"UPDATE `#__fabrik_change_log` SET `time_date` = '1980-01-01 00:00:00' WHERE `time_date` < '1000-01-01';",
