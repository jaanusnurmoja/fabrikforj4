...
namespace Fabrik\Plugin\Form\Log\Extension;
 ...
 * @since       3.0
 */
class Log extends PluginformModel implements SubscriberInterface
{
    ...
    public static function getSubscribedEvents(): array
    {
        $pluginMethods = [
        	"onLoad" => "onLoad",
        	"onDeleteRowsFormTest" => "onDeleteRowsFormTest",
        	"onAfterDeleteRowsForm" => "onAfterDeleteRowsForm",
	...
	public function install()
	{
		...
		$sqls = [
			...
			"UPDATE `#__fabrik_change_log_fields` SET `time_date` = '1980-01-01 00:00:00' WHERE `time_date` < '1000-01-01' OR `time_date` IS NULL;",
