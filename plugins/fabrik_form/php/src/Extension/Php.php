...
class PHP extends PluginformModel implements SubscriberInterface
{
    ...
    {
        $pluginMethods = [
        	"onCanEditGroup" => "onCanEditGroup",
        	"onBeforeProcess" => "onBeforeProcess",
        	"onBeforeStore" => "onBeforeStore",
        	"onBeforeCalculations" => "onBeforeCalculations",
        	"onDeleteRowsForm" => "onDeleteRowsForm",
        	"onAfterDeleteRowsForm" => "onAfterDeleteRowsForm",
        	"onAfterProcess" => "onAfterProcess",
        	"onLoad" => "onLoad",
        	"onBeforeLoad" => "onBeforeLoad",
        	"onElementCanUse" => "onElementCanUse",
        	"onElementCanView" => "onElementCanView",
        	"onJSReady" => "onJSReady",
        	"onJSOpts" => "onJSOpts",
        	"onElementContainerClass" => "onElementContainerClass",
        	"onError" => "onError",
