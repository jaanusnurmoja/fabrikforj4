...
namespace Fabrik\Plugin\Form\Autofill\Extension;
 ...
 * @since       3.0
 */
class Autofill extends PluginformModel implements SubscriberInterface
{
    ...
    public static function getSubscribedEvents(): array
    {
        $pluginMethods = [
        	...
        	"onajax_getAutoFill" => "onajax_getAutoFill"
        ];
