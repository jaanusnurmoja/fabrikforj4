...
/*
	...
	public function install()
	{
		...
		$sqls = [
			...
			"UPDATE `#__fabrik_subs_invoices` SET `transaction_date` = '1980-01-01 00:00:00' WHERE `transaction_date` < '1000-01-01';",
			...
			"UPDATE `#__fabrik_subs_subscriptions` SET `signup_date` = '1980-01-01 00:00:00' WHERE `signup_date` < '1000-01-01';",
			...
			"UPDATE `#__fabrik_subs_users` SET `time_date` = '1980-01-01 00:00:00' WHERE `time_date` < '1000-01-01';",
