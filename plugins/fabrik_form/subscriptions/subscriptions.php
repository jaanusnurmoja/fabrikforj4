...
/*
	...
	public function install()
	{
		...
		$sqls = [
			...
			"UPDATE `#__fabrik_subs_invoices` SET `transaction_date` = '1980-01-01 00:00:00' WHERE `transaction_date` IN ('0000-00-00 00:00:00', '', ' ') OR `signup_date` IS NULL;",
			...
			"UPDATE `#__fabrik_subs_subscriptions` SET `signup_date` = '1980-01-01 00:00:00' WHERE `signup_date` IN ('0000-00-00 00:00:00', '', ' ') OR `signup_date` IS NULL;",
			...
			"UPDATE `#__fabrik_subs_users` SET `time_date` = '1980-01-01 00:00:00' WHERE `time_date` IN ('0000-00-00 00:00:00', '', ' ') OR `time_date` IS NULL;",
