...
namespace Fabrik\Plugin\Form\Paginate\Extension;
 ...
 * @since       3.0
 */
class Paginate extends PluginformModel implements SubscriberInterface
{
	...
	public function getBottomContent()
	{
		...
		FabrikHtml::stylesheet('plugins/fabrik_form/paginate/paginate.css');
	}
