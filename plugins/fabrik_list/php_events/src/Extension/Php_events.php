...
class Php_Events extends \PlgFabrik_list implements SubscriberInterface
{
    ...
    {
        $pluginMethods = [
        	"onFiltersGot" => "onFiltersGot",
        	"onStoreRequestData" => "onStoreRequestData",
        	"onMakeFilters" => "onMakeFilters",
        	"onPreLoadData" => "onPreLoadData",
        	"onLoadData" => "onLoadData",
        	"onDeleteRows" => "onDeleteRows",
        	"onAfterDeleteRows" => "onAfterDeleteRows",
        	"onLoadJavascriptInstance" => "onLoadJavascriptInstance",
        	"onBuildQueryWhere" => "onBuildQueryWhere",
        	"onGetPluginRowHeadings" => "onGetPluginRowHeadings",
        	"onShowInList" => "onShowInList",
        	"onElementCanViewList" => "onElementCanViewList",
        	"onElementSetRowClass" => "onElementSetRowClass",
	...
	public function onElementSetRowClass(&$args)
	{
		...
		return $this->doEvaluate($params->get('list_phpevents_onelementsetrowclass'), $args);
	}
