...
namespace Fabrik\Plugin\List\Caneditrow\Extension;
...
class Caneditrow extends PluginlistModel implements SubscriberInterface
{
	...
	public function onCanEdit($row)
	{
		...
		if (!empty($caneditrow_eval))
		{
			...
			$caneditrow_eval = FabrikPhp::Eval(['code' => $caneditrow_eval, 'vars'=>['data'=>$data]]);
