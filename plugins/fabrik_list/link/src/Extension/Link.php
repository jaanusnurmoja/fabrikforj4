...
namespace Fabrik\Plugin\List\Link\Extension;
...
class Link extends PluginlistModel implements SubscriberInterface
{
	...
	{
		return 'import { FbPlgListLink } from "@fbplglistlink";';
	}
