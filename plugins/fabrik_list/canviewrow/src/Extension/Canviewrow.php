...
namespace Fabrik\Plugin\List\Canviewrow\Extension;
...
class Canviewrow extends PluginlistModel implements SubscriberInterface
{
	...
	public function onCanView($row)
	{
		...
		if (!empty($canviewrow_eval))
		{
			...
			$canviewrow_eval = FabrikPhp::Eval(['code' => $canviewrow_eval, 'vars'=>['data'=>$data]]);
