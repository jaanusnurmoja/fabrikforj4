module.exports = {
    ...
    'corePackageFiles': [
        ...
        'plg_fabrik_element_colourpicker_{version}.zip',
        'plg_fabrik_element_databasejoin_{version}.zip',
        'plg_fabrik_element_date_{version}.zip',
        'plg_fabrik_element_digsig_{version}.zip',
        ...
        'plg_fabrik_element_folder_{version}.zip',
        'plg_fabrik_element_googlemap_{version}.zip',
        'plg_fabrik_element_image_{version}.zip',
        'plg_fabrik_element_internalid_{version}.zip',
        'plg_fabrik_element_ip_{version}.zip',
        'plg_fabrik_element_jdate_{version}.zip',
        'plg_fabrik_element_link_{version}.zip',
        'plg_fabrik_element_lockrow_{version}.zip',
        'plg_fabrik_element_password_{version}.zip',
        'plg_fabrik_element_picklist_{version}.zip',
        'plg_fabrik_element_radiobutton_{version}.zip',
        'plg_fabrik_element_sequence_{version}.zip',
        'plg_fabrik_element_slider_{version}.zip',
        'plg_fabrik_element_textarea_{version}.zip',
        'plg_fabrik_element_thumbs_{version}.zip',
        'plg_fabrik_element_time_{version}.zip',
        'plg_fabrik_element_timer_{version}.zip',
        'plg_fabrik_element_timestamp_{version}.zip',
        'plg_fabrik_element_total_{version}.zip',
        'plg_fabrik_element_user_{version}.zip',
        'plg_fabrik_element_usergroup_{version}.zip',
        'plg_fabrik_element_viewlevel_{version}.zip',
        'plg_fabrik_element_yesno_{version}.zip',
        'plg_fabrik_form_autofill_{version}.zip',
        ...
        'plg_fabrik_list_order_{version}.zip',
        'plg_fabrik_list_php_{version}.zip',
        'plg_fabrik_list_lockrow_{version}.zip',
        ...
        'plg_fabrik_validationrule_emailexists_{version}.zip',
        ...
        'plg_fabrik_validationrule_isiban_{version}.zip',
        'plg_fabrik_validationrule_isnot_{version}.zip',
        'plg_fabrik_validationrule_isnumeric_{version}.zip',
